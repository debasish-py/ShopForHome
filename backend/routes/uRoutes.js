...
//USER OPERATIONS
//Get all users  
userRouter.get("/getalluser",usercontrollers.getusers)
...
userRouter.post("/upload",productcontrollers.bulkUpload)

userRouter.get("/viewProduct",productcontrollers.viewProduct)
